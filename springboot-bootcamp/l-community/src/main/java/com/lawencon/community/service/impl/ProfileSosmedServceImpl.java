...
public class ProfileSosmedServceImpl extends BaseService implements ProfileSosmedService {
	...
	public InsertProfileSosmedDtoRes insert(InsertProfileSosmedDtoReq data) throws Exception {
		...
		try {
			...
			insert.setMsg(CommonConstant.ACTION_ADD.getDetail() + " " + CommonConstant.SUCCESS.getDetail() + ", Profile Sosmed " + CommonConstant.HAS_BEEN_ADDED.getDetail());
		} catch (Exception e) {
			e.printStackTrace();
			rollback();
	...
	public UpdateProfileSosmedDtoRes update(UpdateProfileSosmedDtoReq data) throws Exception {
		...
		try {
			if (data.getVersion() != null) {
				...
				update.setMsg(CommonConstant.ACTION_EDIT.getDetail() + " " + CommonConstant.SUCCESS.getDetail() + ", Profile Sosmed " + CommonConstant.HAS_BEEN_UPDATED.getDetail());
			}
		} catch (Exception e) {
			e.printStackTrace();
			rollback();
	...
	public DeleteByProfileSosmedIdDtoRes deleteById(String id) throws Exception {
		...
		try {
			...
			if (isDeleted) {
				deleteById.setMsg(CommonConstant.ACTION_DELETE.getDetail() + " " + CommonConstant.SUCCESS.getDetail() + ", Profile Sosmed " + CommonConstant.HAS_BEEN_DELETED.getDetail());
			}
		} catch (Exception e) {
			e.printStackTrace();
			rollback();
