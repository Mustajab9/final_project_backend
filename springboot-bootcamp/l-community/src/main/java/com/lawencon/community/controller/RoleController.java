...
public class RoleController {
	...
	@GetMapping
	public ResponseEntity<GetAllRoleDtoRes> getAll(String query, Integer startPage, Integer maxPage) throws Exception {
		GetAllRoleDtoRes roles = roleService.findAll(query, startPage, maxPage);
